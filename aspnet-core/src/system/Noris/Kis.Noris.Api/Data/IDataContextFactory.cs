...
namespace Kis.Noris.Api.Data
{
    ...
    {
		TDataContext CreateDataContext<TDataContext>() where TDataContext : class, IDataContext;

        TDataContext CreateReadOnlyDataContext<TDataContext>() where TDataContext : class, IDataContext;

        void ReleaseDataContext(IDataContext dataContext);
    }
}
